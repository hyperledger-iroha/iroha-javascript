...
import * as metaCrypto from "./meta-crypto.ts";
...
export const PACKAGES_TO_ROLLUP = metaCrypto.PACKAGES.merge(
  Set(["client", "data-model", "i64-fixnum"] as const)
);

export const PACKAGES_TO_BUILD_WITH_TSC =
  metaCrypto.PACKAGES.merge(PACKAGES_TO_ROLLUP);
...
export const PACKAGES_TO_PUBLISH = PACKAGES_TO_ROLLUP.merge(
  Set(["data-model-schema"] as const)
);
